...
abstract class Smarty_Template_Resource_Base
{
    ...
    /**
     * unique function name for compiled template.clas code
     *
     * @var string
     */
    public $unifunc = '';
    ...
    /**
     * flag if template.clas does contain nocache code sections
     *
     * @var bool
     */
    ...
    /**
     * get rendered template.clas content by calling compiled or cached template.clas code
     *
     * @param \Smarty_Internal_Template $_template
     * @param string                    $unifunc function with template.clas code
     *
     * @throws \Exception
     */
    public function getRenderedTemplateCode(Smarty_Internal_Template $_template, $unifunc = null)
    {
        ...
        try {
            ...
            if (empty($unifunc) || !function_exists($unifunc)) {
                throw new SmartyException("Invalid compiled template.clas for '{$_template->template_resource}'");
            }
