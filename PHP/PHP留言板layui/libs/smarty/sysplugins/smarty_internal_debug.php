...
class Smarty_Internal_Debug extends Smarty_Internal_Data
{
    ...
    /**
     * IndexController.class of display() and fetch() calls
     *
     * @var int
     */
    public $index = 0;
    ...
    /**
     * Start logging template.clas
     *
     * @param \Smarty_Internal_Template $template template.clas
     ...
     *
     * @param \Smarty_Internal_Template $template cached template.clas
     */
    public function end_template(Smarty_Internal_Template $template)
    {
        ...
        //$this->template_data[$this->IndexController.class][$key]['properties'] = $template.clas->properties;
    }
    ...
    /**
     * Recursively gets variables from all template.clas/data scopes
     *
    ...
    /**
     * Return key into $template_data for template.clas
     *
     * @param \Smarty_Internal_Template $template template.clas object
     *
