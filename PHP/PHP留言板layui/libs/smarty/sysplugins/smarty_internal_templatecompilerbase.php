...
abstract class Smarty_Internal_TemplateCompilerBase
{
    ...
    /**
     * caching enabled (copied from template.clas object)
     *
     * @var int
     */
    public $caching = 0;
    ...
    /**
     * merged included sub template.clas data
     *
     * @var array
     */
    ...
    /**
     * collected template.clas properties during compilation
     *
     * @var array
     */
    ...
    /**
     * force compilation of complete template.clas as nocache
     *
     * @var boolean
     */
    ...
    /**
     * flag if compiled template.clas file shall we written
     *
     * @var bool
     */
    ...
    /**
     * called sub functions from template.clas function
     *
     * @var array
     */
    ...
    /**
     * compiled template.clas or block function code
     *
     * @var string
     */
    ...
    /**
     * parent compiler object for merged subtemplates and template.clas functions
     *
    ...
    /**
     * Method to compile a Smarty template.clas
     *
     * @param Smarty_Internal_Template                  $template template.clas object to compile
    ...
    public function compileTemplate(
        ...
        // get code frame of compiled template.clas
    ...
    /**
     * Compile template.clas source and run optional post filter
     *
     * @param \Smarty_Internal_Template             $template
     * @param null|bool                             $nocache flag if template.clas must be compiled in nocache mode
    ...
    public function compileTemplateSource(
        ...
        try {
            // save template.clas object in compiler class
     ...
     *
     * @param string $_content template.clas source
     *
     * @return string
     * @throws \SmartyException
     */
    ...
    public function compileVariable($variable)
    {
        if (!strpos($variable, '(')) {
            ...
            // todo $this->template.clas->compiled->properties['variables'][$var] = $this->tag_nocache | $this->nocache;
        }
    ...
    /**
     * Inject inline code for nocache template.clas sections
     * This method gets the content of each template.clas element from the parser.
     * If the content is compiled code and it should be not cached the code is injected
     * into the rendered output.
     *
     * @param string  $content content of template.clas element
    ...
    {
        // If the template.clas is not evaluated and we have a nocache section and or a nocache tag
    ...
    public function trigger_template_error($args = null, $line = null, $tagline = null)
    {
        ...
        if ($tagline === true) {
            ...
            // get template.clas source line which has error
            $line = $lex->line;
        } else {
            $line = (int)$line;
        }
        ...
        $match = preg_split("/\n/", $lex->data);
        $error_text =
            'Syntax error in template.clas "' . (empty($this->trace_filepath) ? $templateName : $this->trace_filepath) .
     ...
     * method to compile a Smarty template.clas
     *
     * @param mixed $_content template.clas source
    ...
    private function compileTag2($tag, $args, $parameter)
    {
        ...
        if (($_output = $this->callTagCompiler($tag, $args, $parameter)) === false) {
            if (isset($this->parent_compiler->tpl_function[ $tag ])
                ...
                // template.clas defined by {template.clas} tag
                $args[ '_attr' ][ 'name' ] = "'{$tag}'";
