...
abstract class Smarty_CacheResource_KeyValueStore extends Smarty_CacheResource
{
    ...
    /**
     * Read the cached template.clas and process the header
     *
     * @param \Smarty_Internal_Template $_smarty_tpl do not change variable name, is used by compiled template.clas
     * @param Smarty_Template_Cached    $cached      cached object
    ...
    /**
     * Write the rendered template.clas output to cache
     *
     * @param Smarty_Internal_Template $_template template.clas object
    ...
    /**
     * Read cached template.clas from cache
     *
     * @param Smarty_Internal_Template $_template template.clas object
     *
    ...
    /**
     * Empty cache for a specific template.clas
     * {@internal the $exp_time argument is ignored altogether}}
     *
     * @param Smarty  $smarty        Smarty object
    ...
    protected function invalidate(
        ...
        if (!$resource_name && !$cache_id && !$compile_id) {
            $key = 'IVK#ALL';
        } // invalidate all caches by template.clas
        else {
            if ($resource_name && !$cache_id && !$compile_id) {
    ...
    /**
     * Check is cache is locked for this template.clas
     *
     * @param Smarty                 $smarty Smarty object
     * @param Smarty_Template_Cached $cached cached object
     *
    ...
    /**
     * Lock cache for this template.clas
     *
     * @param Smarty                 $smarty Smarty object
     * @param Smarty_Template_Cached $cached cached object
     *
    ...
    /**
     * Unlock cache for this template.clas
     *
     * @param Smarty                 $smarty Smarty object
     * @param Smarty_Template_Cached $cached cached object
     *
