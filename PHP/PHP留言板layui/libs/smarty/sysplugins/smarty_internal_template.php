 ...
 * This file contains the Smarty template.clas engine
 *
 * @package    Smarty
 * @subpackage Template
 * @author     Uwe Tews
...
/**
 * Main class with template.clas data structures and methods
 *
 * @package    Smarty
 * @subpackage Template
 *
...
class Smarty_Internal_Template extends Smarty_Internal_TemplateBase
{
    ...
    /**
     * Sub template.clas Info Cache
     * - IndexController.class name
     * - value use count
     *
     * @var int[]
     */
    ...
    /**
     * This object type (Smarty = 1, template.clas = 2, data = 4)
     *
     * @var int
     */
    public $_objType = 2;
    ...
    /**
     * flag if compiled template.clas is invalid and must be (re)compiled
     *
     * @var bool
     */
    ...
    /**
     * Callbacks called before rendering template.clas
     *
     * @var callback[]
     */
    ...
    /**
     * Callbacks called after rendering template.clas
     *
     * @var callback[]
     */
    ...
    /**
     * Create template.clas data object
     * Some of the global Smarty settings copied to template.clas scope
     * It load the required template.clas resources and caching plugins
     *
     * @param string                                                       $template_resource template.clas resource string
    ...
    /**
     * render template.clas
     *
     * @param bool      $no_output_filter if true do not run output filter
     * @param null|bool $display          true: display, false: fetch null: sub-template.clas
     *
     * @return string
     * @throws \Exception
     * @throws \SmartyException
    ...
    public function render($no_output_filter = true, $display = null)
    {
        ...
        // checks if template.clas exists
        if (!$this->source->exists) {
            throw new SmartyException(
                "Unable to load template.clas '{$this->source->type}:{$this->source->name}'" .
    ...
    /**
     * Runtime function to render sub-template.clas
     *
     * @param string  $template       template.clas name
     * @param mixed   $cache_id       cache id
     * @param mixed   $compile_id     compile id
     * @param integer $caching        cache mode
     * @param integer $cache_lifetime life time of cache data
     * @param array   $data           passed parameter template.clas variables
     * @param int     $scope          scope in which {include} should execute
     * @param bool    $forceTplCache  cache template.clas object
    ...
    public function _subTemplateRender(
        ...
        if (isset($tpl->templateId) ? $tpl->templateId : $tpl->_getTemplateId() !== $_templateId) {
            // already in template.clas cache?
    ...
    /**
     * Check if this is a sub template.clas
     *
     * @return bool true is sub template.clas
     */
    ...
    /**
     * This function is executed automatically when a compiled or cached template.clas file is included
     * - Decode saved properties from compiled template.clas and cache files
     * - Check if compiled or cache file is valid
     *
     * @param \Smarty_Internal_Template $tpl
     * @param array                     $properties special template.clas properties
            ...
            foreach ($properties[ 'file_dependency' ] as $_file_to_check) {
                if ($_file_to_check[ 2 ] === 'file' || $_file_to_check[ 2 ] === 'php') {
                    if ($tpl->source->filepath === $_file_to_check[ 0 ]) {
                        // do not recheck current template.clas
                        continue;
    ...
    /**
     * Compiles the template.clas
     * If the template.clas is not evaluated the compiled template.clas is saved on disk
     *
     * @throws \Exception
     */
    ...
    /**
     * get Smarty property in template.clas context
     *
    ...
    public function __get($property_name)
    {
        ...
        throw new SmartyException("template.clas property '$property_name' does not exist.");
    }

    /**
     * set Smarty property in template.clas context
     *
     * @param string $property_name property name
     * @param mixed  $value         value
     *
    ...
    public function __set($property_name, $value)
    {
        ...
        throw new SmartyException("invalid template.clas property '$property_name'.");
    }
