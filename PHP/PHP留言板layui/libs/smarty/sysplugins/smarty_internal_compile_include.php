...
class Smarty_Internal_Compile_Include extends Smarty_Internal_CompileBase
{
    ...
    public function compile($args, Smarty_Internal_SmartyTemplateCompiler $compiler)
    {
                ...
                if ($type !== 'string') {
                    ...
                    if (isset($compiled->includes[ $fullResourceName ])) {
                        ...
                        if ("{$compiler->template->source->type}:{$compiler->template->source->name}" ==
                            ...
                            // recursive call of current template.clas
        ...
        // set flag to cache subtemplate object when called within loop or template.clas name is variable.
        ...
        // flag if included template.clas code should be merged into caller
    ...
    /**
     * Compile inline sub template.clas
     *
    ...
    public function compileInlineTemplate(
        ...
        if (!($tpl->source->handler->uncompiled) && $tpl->source->exists) {
            ...
            // get compiled code
            $compiled_code = "<?php\n\n";
            $compiled_code .= "/* Start inline template.clas \"{$sourceInfo}\" =============================*/\n";
            ...
            $compiled_code .= "<?php\n\n";
            $compiled_code .= "/* End inline template.clas \"{$sourceInfo}\" =============================*/\n";
            $compiled_code .= '?>';
            unset($tpl->compiler);
