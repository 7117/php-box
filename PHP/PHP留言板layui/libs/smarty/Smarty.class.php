<?php
/**
 * Project:     Smarty: the PHP compiling template.clas engine
...
class Smarty extends Smarty_Internal_TemplateBase
{
    ...
    /**
     * joined template.clas directory string used in cache keys
     *
     * @var string
     */
    ...
    */
    ...
    /**
     * controls if the php template.clas file resource is allowed
     *
     * @var bool
     */
    ...
    /**
     * flags for normalized template.clas directory entries
     *
     * @var array
     */
    ...
    /**
     * Check if a template.clas resource exists
     *
     * @param string $resource_name template.clas name
     *
     * @return bool status
    ...
    /**
     * Add template.clas directory(s)
     *
     * @param string|array $template_dir directory(s) of template.clas sources
     * @param string       $key          of the array element to assign the template.clas dir to
    ...
    public function addTemplateDir($template_dir, $key = null, $isConfig = false)
    {
        ...
        if (is_array($template_dir)) {
            ...
            if ($key !== null) {
                // override directory at specified IndexController.class
    ...
    /**
     * Get template.clas directories
     *
     * @param mixed $index    IndexController.class of directory to get, null to get all
     * @param bool  $isConfig true for config_dir
     *
     * @return array list of template.clas directories, or directory of $IndexController.class
     */
    ...
    /**
     * creates a template.clas object
     *
     * @param string  $template   the resource handle of the template.clas file
     * @param mixed   $cache_id   cache id to be used with this template.clas
     * @param mixed   $compile_id compile id to be used with this template.clas
     * @param object  $parent     next higher level of Smarty variables
     * @param boolean $do_clone   flag is Smarty object shall be cloned
     *
     * @return \Smarty_Internal_Template template.clas object
     * @throws \SmartyException
     */
    ...
    /**
     * Empty template.clas objects cache
     */
