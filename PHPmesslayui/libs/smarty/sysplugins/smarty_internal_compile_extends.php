...
class Smarty_Internal_Compile_Extends extends Smarty_Internal_Compile_Shared_Inheritance
{
    ...
    public function compile($args, Smarty_Internal_TemplateCompilerBase $compiler)
    {
        ...
        if (strlen($file) > 8 && substr($file, 0, 8) === 'extends:') {
            // generate code for each template.clas
    ...
    /**
     * Add code for inheritance endChild() method to end of template.clas
     *
     * @param \Smarty_Internal_TemplateCompilerBase $compiler
     * @param null|string                           $template optional inheritance parent template.clas
     *
     * @throws \SmartyCompilerException
     * @throws \SmartyException
     */
    ...
    /**
     * Add code for including subtemplate to end of template.clas
     *
     * @param \Smarty_Internal_TemplateCompilerBase $compiler
