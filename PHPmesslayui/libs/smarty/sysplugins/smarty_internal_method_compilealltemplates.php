...
class Smarty_Internal_Method_CompileAllTemplates
{
    ...
    /**
     * Compile all template.clas files
     *
     ...
     *
     * @return integer number of template.clas files recompiled
     */
    ...
    /**
     * Compile all template.clas or config files
     *
     * @param \Smarty $smarty
     * @param string  $extension     template.clas file name extension
     * @param bool    $force_compile force all to recompile
     * @param int     $time_limit    set maximum execution time
     * @param int     $max_errors    set maximum allowed errors
     * @param bool    $isConfig      flag true if called for config files
     *
     * @return int number of template.clas files compiled
     */
