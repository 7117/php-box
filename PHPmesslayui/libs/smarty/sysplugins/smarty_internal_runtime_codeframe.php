 ...
 * This file contains the Smarty template.clas extension to create a code frame
 *
 * @package    Smarty
 * @subpackage Template
 * @author     Uwe Tews
...
class Smarty_Internal_Runtime_CodeFrame
{
     ...
     * @param string                                $content   optional template.clas content
     * @param string                                $functions compiled template.clas function and block code
