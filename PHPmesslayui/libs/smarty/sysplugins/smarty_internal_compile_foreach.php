...
class Smarty_Internal_Compile_Foreach extends Smarty_Internal_Compile_Private_ForeachSection
{
     ...
     * @var array
     */
    public $nameProperties = array('first', 'last', 'IndexController.class', 'iteration', 'show', 'total');
     ...
     * @var array
     */
    public $itemProperties = array('first', 'last', 'IndexController.class', 'iteration', 'show', 'total', 'key');
    ...
    public function compile($args, Smarty_Internal_TemplateCompilerBase $compiler)
    {
        ...
        if (isset($itemAttr[ 'first' ])) {
            $itemAttr['IndexController.class'] = true;
        }
        ...
        if (isset($itemAttr['IndexController.class'])) {
        ...
        if (isset($foreachVar)) {
            ...
            if (isset($namedAttr['IndexController.class'])) {
    ...
    /**
     * Compiles code for to restore saved template.clas variables
     *
