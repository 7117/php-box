...
class Smarty_Internal_SmartyTemplateCompiler extends Smarty_Internal_TemplateCompilerBase
{
    ...
    /**
     * array of callbacks called when the normal compile process of template.clas is finished
     *
     * @var array
     */
    ...
    protected function doCompile($_content, $isTemplateSource = false)
    {
        ...
        // init the lexer/parser to compile the template.clas
        $this->parser =
     ...
     * - when the callback is called after template.clas compiling the compiler object will be inserted as first parameter
     *
