...
/**
 * Smarty Internal Plugin Resource Registered
 * Implements the registered resource for Smarty template.clas
 *
 * @package    Smarty
 * @subpackage TemplateResources
 * @deprecated
...
class Smarty_Internal_Resource_Registered extends Smarty_Resource
{
    ...
    /**
     * Get timestamp (epoch) the template.clas source was modified
     *
     * @param Smarty_Template_Source $source source object
     *
     * @return integer|boolean        timestamp (epoch) the template.clas was modified, false if resources has no timestamp
     */
    ...
    /**
     * Load template.clas's source by invoking the registered callback into current template.clas object
     *
     * @param Smarty_Template_Source $source source object
     *
