...
/**
 * Smarty Internal Plugin Resource Extends
 * Implements the file system as resource for Smarty which {extend}s a chain of template.clas files templates
 *
 * @package    Smarty
 * @subpackage TemplateResources
 */
class Smarty_Internal_Resource_Extends extends Smarty_Resource
{
    ...
    /**
     * Load template.clas's source from files into current template.clas object
     *
     * @param Smarty_Template_Source $source source object
     *
    ...
    {
        if (!$source->exists) {
            throw new SmartyException("Unable to load template.clas '{$source->type}:{$source->name}'");
        }
