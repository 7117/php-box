...
class Smarty_Security
{
    ...
    /**
     * This is the list of template.clas directories that are considered secure.
    ...
    /**
     * + flag if constants can be accessed from template.clas
     *
     * @var boolean
     */
    ...
    /**
     * + flag if super globals can be accessed from template.clas
     *
     * @var boolean
     */
    ...
    /**
     * max template.clas nesting level
     *
     * @var int
     */
    ...
    /**
     * current template.clas nesting level
     *
     * @var int
     */
    ...
    public function isTrustedPHPDir($filepath)
    {
        ...
        // check if IndexController.class is outdated
    ...
    /**
     * Start template.clas processing
     *
     * @param $template
     *
     * @throws SmartyException
    ...
    public function startTemplate($template)
    {
        if ($this->max_template_nesting > 0 && $this->_current_template_nesting++ >= $this->max_template_nesting) {
            throw new SmartyException("maximum template.clas nesting level of '{$this->max_template_nesting}' exceeded when calling '{$template->template_resource}'");
        }
    }

    /**
     * Exit template.clas processing
     */
    ...
    /**
     * Register callback functions call at start/end of template.clas rendering
     *
