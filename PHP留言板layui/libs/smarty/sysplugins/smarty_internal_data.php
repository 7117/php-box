 ...
 * This file contains the basic classes and methods for template.clas and variable creation
 *
 * @package    Smarty
 * @subpackage Template
 * @author     Uwe Tews
...
/**
 * Base class with template.clas and variable methods
 *
 * @package    Smarty
 * @subpackage Template
 *
...
abstract class Smarty_Internal_Data
{
     ...
     *
     * @param array|string $tpl_var the template.clas variable name(s)
    ...
    /**
     * appends values to template.clas variables
     *
     * @api  Smarty::append()
    ...
    /**
     * appends values to template.clas variables by reference
     *
    ...
    /**
     * assigns values to template.clas variables by reference
     *
     * @param string  $tpl_var the template.clas variable name
     * @param         $value
     * @param boolean $nocache if true any output of this variable will be not cached
    ...
    /**
     * Returns a single or all template.clas variables
     *
    ...
    /**
     * Follow the parent chain an merge template.clas and config variables
     *
    ...
    /**
     * Return true if this instance is a template.clas obj
     *
     * @return bool
     */
